...
export function ProductCoverFlow() {
  ...
  return (
    <section
      className="coverflow-stage relative isolate overflow-hidden bg-brand-stage px-4 py-20 text-brand-cream sm:px-6 md:py-28"
    ...
    >
      ...
      <Button
        ...
        className="absolute left-3 top-1/2 z-20 size-11 -translate-y-1/2 rounded-full border border-brand-cream/20 bg-brand-stage/70 text-brand-cream backdrop-blur-md hover:bg-brand-toast hover:text-brand-cream sm:left-6 md:size-12"
      >
      ...
      <Button
        ...
        className="absolute right-3 top-1/2 z-20 size-11 -translate-y-1/2 rounded-full border border-brand-cream/20 bg-brand-stage/70 text-brand-cream backdrop-blur-md hover:bg-brand-toast hover:text-brand-cream sm:right-6 md:size-12"
      >
      ...
      <div className="mx-auto max-w-7xl">
        <header className="relative z-10 mx-auto min-h-24 max-w-3xl text-center" aria-live="polite">
          <h2 className="font-display text-3xl font-extrabold leading-tight text-brand-toast sm:text-4xl md:text-5xl">
            {activeProduct.name[lang]}
          </h2>
          <p className="mt-3 font-ui text-sm text-brand-cream/70 sm:text-base">
        ...
        <div className="relative mt-4 grid h-[390px] grid-cols-[1fr_minmax(230px,360px)_1fr] items-center sm:h-[470px] md:h-[520px]">
          ...
          <Link
            ...
            className="coverflow-active relative z-10 col-start-2 flex h-full items-center justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-toast focus-visible:ring-offset-4 focus-visible:ring-offset-brand-stage"
          >
            <img
        ...
        <ul className="mx-auto mt-6 grid max-w-4xl grid-cols-2 gap-x-5 gap-y-5 sm:flex sm:flex-wrap sm:justify-center sm:gap-8 md:mt-8 md:gap-12">
          {features.map(({ icon: Icon, label }) => (
            <li key={label.en} className="flex items-center justify-center gap-2 font-ui text-[11px] uppercase text-brand-cream/75 sm:text-xs">
