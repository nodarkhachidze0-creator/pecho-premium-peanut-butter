...
const en: Dict = {
  ...
  "pdp.ingredients": "Ingredients & Allergens",
  "pdp.storage": "Storage Conditions",
  "pdp.nutrition": "Nutritional Value",
  "pdp.weight": "Weight",
  "pdp.description": "Product Description",
  "pdp.descriptionContent": "PECHO — natural peanut butter created for those who value quality alongside taste.\nPECHO is made from 100% natural, freshly roasted peanuts, without artificial additives, preservatives, or palm oil.\nCarefully selected and roasted peanuts give the product its authentic peanut aroma, rich taste, and pleasant texture.\nThere is nothing unnecessary in PECHO — only what real peanut butter needs.\n100% natural • No added sugar • No palm oil • No additives",
  "pdp.ingredientsContent": "Ingredients: roasted peanuts, sea salt.\nNutritional composition: due to the natural composition of peanuts, PECHO contains protein, beneficial fats, and micronutrients such as magnesium, iron, potassium, zinc, and copper. It also contains B vitamins and vitamin E.\nAllergen: the product’s main ingredient is peanut, a known allergen.\nWarning: not recommended for people with a peanut allergy. If you have a specific health condition, consult a doctor before consuming the product.",
  "pdp.storageContent": "Storage conditions: store in a cool, dry place away from direct sunlight and high temperatures.\nPeanut oil may naturally separate on the surface of the peanut butter — this is a natural property of the product and does not indicate spoilage. Stir well before use.\nRefrigerate after opening.\nShelf life: 12 months.",
  "pdp.nutritionContent": "See the table below for nutritional information.",
  ...
  "footer.tagline": "A healthy life begins with one spoonful.",
...
const ka: Dict = {
  ...
  "pdp.ingredients": "შემადგენლობა & ალერგენები",
  "pdp.storage": "შენახვის პირობები",
  "pdp.nutrition": "კვებითი ღირებულება",
  "pdp.weight": "წონა",
  "pdp.description": "პროდუქტის აღწერა",
  "pdp.descriptionContent": "PECHO — ბუნებრივი მიწისთხილის კარაქი, შექმნილი მათთვის, ვინც გემოსთან ერთად ხარისხსაც აფასებს.\nPECHO მზადდება 100% ბუნებრივი, ახლად მოხალული მიწისთხილისგან, ყოველგვარი ხელოვნური დანამატების, კონსერვანტებისა და პალმის ზეთის გარეშე.\nმიწისთხილის სწორად შერჩეული და მოხალული მარცვლები უზრუნველყოფს პროდუქტის ნამდვილ მიწისთხილის არომატს, მდიდარ გემოსა და სასიამოვნო ტექსტურას.\nPECHO-ში არაფერი ზედმეტი არ არის — მხოლოდ ის, რაც ნამდვილ მიწისთხილის კარაქს სჭირდება.\n100% ბუნებრივი • შაქრის გარეშე • პალმის ზეთის გარეშე • დანამატების გარეშე",
  "pdp.ingredientsContent": "შემადგენლობა: მოხალული მიწისთხილი, ზღვის მარილი.\nკვებითი შემადგენლობა: მიწისთხილის ბუნებრივი შემადგენლობიდან გამომდინარე, PECHO შეიცავს ცილებს, სასარგებლო ცხიმებს და ისეთ მიკროელემენტებს, როგორიცაა მაგნიუმი, რკინა, კალიუმი, თუთია და სპილენძი. ასევე შეიცავს B ჯგუფის ვიტამინებსა და E ვიტამინს.\nალერგენი: პროდუქტის ძირითადი ინგრედიენტია მიწისთხილი, რომელიც წარმოადგენს ცნობილ ალერგენს.\nგაფრთხილება: არ არის რეკომენდებული მიწისთხილზე ალერგიის მქონე პირებისთვის. განსაკუთრებული ჯანმრთელობის მდგომარეობის შემთხვევაში, პროდუქტის მიღებამდე მიმართეთ ექიმს.",
  "pdp.storageContent": "შენახვის პირობები: შეინახეთ მშრალ და გრილ ადგილას, მოარიდეთ მზის პირდაპირ სხივებს და მაღალ ტემპერატურას.\nმიწისთხილის კარაქის ზედაპირზე შესაძლოა ბუნებრივად გამოიყოს მიწისთხილის ზეთი — ეს არის პროდუქტის ბუნებრივი თვისება და არ მიუთითებს მის გაფუჭებაზე. მიღებამდე კარგად მოურიეთ.\nშეფუთვის გახსნის შემდეგ შეინახეთ მაცივარში.\nვარგისიანობის ვადა: 12 თვე.",
  "pdp.nutritionContent": "კვებითი ღირებულების შესახებ ინფორმაცია იხილეთ ქვემოთ მოცემულ ცხრილში.",
  ...
  "footer.tagline": "ჯანსაღი ცხოვრება იწყება ერთი კოვზიდან",
  ...
  "partners.contactNote":
    "დაგვიკავშირდით ნებისმიერ დროს, ჩვენი გუნდი კი უმოკლეს დროში გიპასუხოთ.",
