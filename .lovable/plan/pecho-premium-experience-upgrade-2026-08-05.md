...
Everything should look like the current Pecho website, only significantly more polished and interactive.

---

## Animation Philosophy

Animations must feel **premium**, **minimal**, and **expensive**.
...
The experience should resemble premium product websites like Apple, Red Bull, Fly By Jing, or Nothing.

---

## Product Eyes

The moving eyes are one of Pecho's signature features.

Requirements:

- movement must be extremely smooth
- pupils should never leave the white area
- movement should be limited naturally
- return smoothly to center after interaction
- no jitter
- no lag
- support multiple jars inside the same image independently

This interaction should become one of the most memorable elements of the website.

---

## Image Quality

Do not crop existing product images.

Always display the full product.

Maintain original proportions.

Use object-fit correctly.

Images must remain sharp on Retina and high-DPI displays.
...
Prefer existing browser APIs, CSS transforms, requestAnimationFrame and IntersectionObserver.

Maintain smooth 60 FPS on modern desktop and mobile devices.

---

## Mobile Experience

The mobile version must receive the same level of polish as desktop.

Nothing should feel like a simplified version.

Interactive eyes, animations, sticky add-to-cart and transitions should all work naturally on touch devices.
...
The finished website should feel like a premium international food brand.

Visitors should immediately think:

> "This feels like a world-class product website."

The experience should be noticeably more refined, interactive and memorable than [snacky.ge](http://snacky.ge) while remaining elegant, fast and professional.